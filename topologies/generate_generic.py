...
parser.add_argument("-s", "--switches", help="número de switches", dest="s", type=int, default=4)
parser.add_argument("-l", "--links", help="número links na rede (default: dobro de switches)", dest="l", type=int)
parser.add_argument("-o","--output", help="Arquivo de saída", default='topo.txt')
parser.add_argument("-v", "--view", help="visualizar a rede", dest="view", action="store_true", default=False)
